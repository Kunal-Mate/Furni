                    ...
                    <div class="col-3">
                        <div class="text-center">
                            <!-- <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Add"
                                                href="javascript:void(0)"><i class="ti ti-plus"></i> Add New Role</a> -->

                            <a class="btn btn-primary" href="{{ route('roles.create') }}"><i class="ti ti-plus"></i> Add New
                                Role</a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form method="post" enctype="multipart/form-data"
                                                    action="{{ route('roles.update', $us->id) }}">
                                                    @csrf
                                                    @method('PUT')
...
@section('customJs')
    <script>
        $(document).on("click", ".sa-confirm", function () {
            ...
            Swal.fire({
                title: "Are you sure?",
                text: `You want to delete '${Name}' Role!`,
                icon: "warning",
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response["success"] == true) {
                        ...
                        $('#RoleForm .form-control').removeClass('is-invalid');
