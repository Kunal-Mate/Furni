                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                            <div class="mb-3 mb-sm-0">
                                <h5 class="card-title fw-semibold">Revenue Forecast1</h5>
                            </div>
                            <div>
                            ...
                            <table class="table text-nowrap align-middle table-custom mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="ps-0">
                                            <div class="d-flex align-items-center gap-6">
                                                <img src="{{ asset('assets/images/products/dash-prd-2.jpg') }}" alt="prd1"
                                                    width="48" class="rounded" />
                                                <div>
                                    ...
                                    <tr>
                                        <td class="ps-0">
                                            <div class="d-flex align-items-center gap-6">
                                                <img src="{{ asset('assets/images/products/dash-prd-3.jpg') }}" alt="prd1"
                                                    width="48" class="rounded" />
                                                <div>
                                    ...
                                    <tr>
                                        <td class="ps-0">
                                            <div class="d-flex align-items-center gap-6">
                                                <img src="{{ asset('assets/images/products/dash-prd-4.jpg') }}" alt="prd1"
                                                    width="48" class="rounded" />
                                                <div>
