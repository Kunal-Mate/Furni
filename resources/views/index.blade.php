        ...
        <table class="table text-nowrap align-middle table-custom mb-0">
          ...
          <tr>
            ...
            <div class="d-flex align-items-center gap-6">
              <img src="{{ asset('assets/images/products/dash-prd-1.jpg') }}" alt="prd1" width="48"
              class="rounded" />
              <div>
          ...
          <tr>
            <td class="ps-0">
            <div class="d-flex align-items-center gap-6">
              <img src="{{ asset('assets/images/products/dash-prd-2.jpg') }}" alt="prd1" width="48"
              class="rounded" />
              <div>
          ...
          <tr>
            <td class="ps-0">
            <div class="d-flex align-items-center gap-6">
              <img src="{{ asset('assets/images/products/dash-prd-3.jpg') }}" alt="prd1" width="48"
              class="rounded" />
              <div>
          ...
          <tr>
            <td class="ps-0">
            <div class="d-flex align-items-center gap-6">
              <img src="{{ asset('assets/images/products/dash-prd-4.jpg') }}" alt="prd1" width="48"
              class="rounded" />
              <div>
