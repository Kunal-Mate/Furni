<footer class="footer bg-dark pb-4 py-lg-5" data-bs-theme="dark">
  <div class="container pt-5 pt-lg-4 mt-sm-2 mt-md-3">
    <div class="row pb-5">
      ...
      <!-- Category links -->
      <div class="col-md-auto col-xl-2 text-center order-md-1 pt-4 pt-md-0 d-none">
    ...
    <!-- <p class="fs-xs text-body text-center pt-lg-4 mt-n2 mt-md-0 mb-0">
        © All rights reserved. Made by <span class="animate-underline"><a
            class="animate-target text-white text-decoration-none" href="https://createx.studio/" target="_blank"
            rel="noreferrer">Createx Studio</a></span>
      </p> -->
  </div>
</footer>