    ...
    <section class="container mb-4">
        <div class="overflow-auto" data-simplebar="" data-simplebar-auto-hide="false">
            <div class="row row-cols-6 g-0" style="min-width: 960px">
                <div class="col">
                    <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="{{ route('catalog')}}">
                        <div class="ratio" style="max-width: 164px; --cz-aspect-ratio: calc(80 / 164 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/brands/apple-light-mode.svg') }}"
                                class="d-none-dark" alt="Apple">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/brands/apple-dark-mode.svg') }}"
                ...
                <div class="col">
                    <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="{{ route('catalog')}}">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/motorola-light-mode.svg') }}"
                            class="d-none-dark" alt="Motorola">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/motorola-dark-mode.svg') }}"
                            class="d-none d-block-dark" alt="Motorola">
                    </a>
                </div>
                <div class="col">
                    <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="{{ route('catalog')}}">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/xiaomi-light-mode.svg') }}"
                            class="d-none-dark" alt="Xiaomi">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/xiaomi-dark-mode.svg') }}"
                            class="d-none d-block-dark" alt="Xiaomi">
                    </a>
                </div>
                <div class="col">
                    <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="{{ route('catalog')}}">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/canon-light-mode.svg') }}"
                            class="d-none-dark" alt="Canon">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/canon-dark-mode.svg') }}"
                            class="d-none d-block-dark" alt="Canon">
                    </a>
                </div>
                <div class="col">
                    <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="{{ route('catalog')}}">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/samsung-light-mode.svg') }}"
                            class="d-none-dark" alt="Samsung">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/samsung-dark-mode.svg') }}"
                            class="d-none d-block-dark" alt="Samsung">
                    </a>
                </div>
                <div class="col">
                    <a class="d-flex justify-content-center py-3 px-2 px-xl-3" href="{{ route('catalog')}}">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/sony-light-mode.svg') }}"
                            class="d-none-dark" alt="Sony">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/brands/sony-dark-mode.svg') }}"
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 gy-5">
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/01.png') }}"
                                class="hover-effect-target" alt="Smartphones">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Smartphones</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Apple iPhone</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Samsung</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Xiaomi</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Nokia</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Meizu</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/02.png') }}"
                                class="hover-effect-target" alt="Powerbank">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Accessories</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Accessory Kits</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Batteries &amp; Battery Packs</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Cables</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Car Accessories</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Charges &amp; Power Adapters</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">FM Transmitters</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/03.png') }}"
                                class="hover-effect-target" alt="Tablets">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Tablets</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Apple iPad</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Android Tablets</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Samsung</a>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/04.png') }}"
                                class="hover-effect-target" alt="Wearable Electronics">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Wearable Electronics</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Smart Watches</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Fitness Trackers</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Smart Glasses</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">E-books</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Clips, Arm &amp; Wristbands</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Voice Recorders</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/05.png') }}"
                                class="hover-effect-target" alt="Computers">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Computers &amp; Laptops</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Asus</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Acer</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">HP (Hewlett Packard)</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Lenovo</a>
                        ...
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Apple MacBook</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/06.png') }}"
                                class="hover-effect-target" alt="Cameras">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Cameras, Photo &amp; Video</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Photo Cameras</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Video Cameras</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Action Cameras</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Camcorders</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Studio Equipment</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Tripods</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Bags and Covers</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/07.png') }}"
                                class="hover-effect-target" alt="Headphones">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Headphones</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Apple</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Defunc</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">HyperX</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">JBL</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Logitech</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Panasonic</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col">
                <div class="hover-effect-scale">
                    <a class="d-block bg-body-tertiary rounded p-4 mb-4" href="{{ route('catalog')}}">
                        <div class="ratio" style="--cz-aspect-ratio: calc(184 / 258 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/categories/08.png') }}"
                                class="hover-effect-target" alt="Video Games">
                        </div>
                    </a>
                    <h2 class="h6 d-flex w-100 pb-2 mb-1">
                        <a class="animate-underline animate-target d-inline text-truncate"
                            href="{{ route('catalog')}}">Video Games</a>
                    </h2>
                    <ul class="nav flex-column gap-2 mt-n1">
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">PlayStation 5</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">PlayStation Controllers</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">PlayStation Games</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Gaming PCs</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Nintendo Switch</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Xbox Series X/S</a>
                        </li>
                        <li class="d-flex w-100 pt-1">
                            <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                href="{{ route('catalog')}}">Gaming Peripherals</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="row g-3 g-lg-4">
            <div class="col-md-7">
                <div
                    ...
                    <div
                        ...
                        <a class="btn btn-primary" href="{{ route('product-general')}}">
                            From $899
                    ...
                    <div class="position-relative z-1 w-100 align-self-end order-sm-1" style="max-width: 416px">
                        <div class="ratio rtl-flip" style="--cz-aspect-ratio: calc(320 / 416 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/banners/iphone-1.png') }}"
                                alt="iPhone 14">
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-5">
                <div
                    ...
                    <a class="position-relative z-1 d-block w-100" href="{{ route('product-general')}}">
                        <div class="ratio rtl-flip" style="--cz-aspect-ratio: calc(159 / 525 * 100%)">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/banners/ipad.png') }}" width="525"
                                alt="iPad">
                        </div>
                    </a>
                </div>
            ...
            <div class="col">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="{{ route('product-general')}}">
                            <span
                    ...
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
                        ...
                        <h3 class="pb-1 mb-2">
                            <a class="d-block fs-sm fw-medium text-truncate" href="{{ route('product-general')}}">
                                <span class="animate-target">VRB01 Virtual Reality Glasses</span>
                            </a>
                        </h3>
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="h5 lh-1 mb-0">$340.99 <del class="text-body-tertiary fs-sm fw-normal">$430.00</del>
                            </div>
                            <button type="button"
                ...
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="position-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="{{ route('product-general')}}">
                            ...
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/04.png') }}" alt="MacBook">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
            ...
            <div class="col">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="posittion-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="{{ route('product-general')}}">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/07.png') }}" alt="iPad Pro">
                            </div>
                        </a>
                    </div>
                    <div class="w-100 min-w-0 px-1 pb-2 px-sm-3 pb-sm-3">
            ...
            <div class="col">
                <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                    <div class="posittion-relative">
                        ...
                        <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="{{ route('product-general')}}">
                            <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/08.png') }}"
                ...
                <div class="col-md-6 col-lg-5 col-xl-4 offset-lg-1 offset-xl-2">
                    <ul class="list-unstyled d-flex flex-column gap-4 ps-md-4 ps-lg-0 mb-3">
                        <li class="nav flex-nowrap align-items-center position-relative">
                            <img src="{{ asset('frontend/assets/img/home/electronics/vlog/01.jpg') }}" class="rounded"
                                width="140" alt="Video cover">
                            <div class="ps-3">
                                <div class="fs-xs text-body-secondary lh-sm mb-2">6:16</div>
                                <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">5 New Cool
                                    Gadgets You Must See on Cromā - Cheap Budget</a>
                            </div>
                        </li>
                        <li class="nav flex-nowrap align-items-center position-relative">
                            <img src="{{ asset('frontend/assets/img/home/electronics/vlog/02.jpg') }}" class="rounded"
                                width="140" alt="Video cover">
                            <div class="ps-3">
                                ...
                                <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">5 Super
                                    Useful Gadgets on Cromā You Must Have in 2023</a>
                            </div>
                        </li>
                        <li class="nav flex-nowrap align-items-center position-relative">
                            <img src="{{ asset('frontend/assets/img/home/electronics/vlog/03.jpg') }}" class="rounded"
                                width="140" alt="Video cover">
                            <div class="ps-3">
                                <div class="fs-xs text-body-secondary lh-sm mb-2">8:40</div>
                                <a class="nav-link fs-sm hover-effect-underline stretched-link p-0" href="#!">Top 5 New
                                    Amazing Gadgets on Cromā You Must See</a>
                            </div>
                        </li>
                    </ul>
