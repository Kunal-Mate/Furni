        ...
        <div class="border-bottom">
            <ul class="nav nav-underline flex-nowrap gap-4">
                <li class="nav-item me-sm-2">
                    <a class="nav-link" href="{{ route('product-general')}}">General info</a>
                </li>
                <li class="nav-item me-sm-2">
        ...
        <div class="row">
                        ...
                        <div class="container d-flex align-items-center">
                            <div class="d-flex align-items-center min-w-0 ms-n2 me-3">
                                <div class="ratio ratio-1x1 flex-shrink-0" style="width: 50px">
                                    <img src="{{ asset('frontend/assets/img/shop/electronics/thumbs/10.png') }}"
                                        alt="iPhone 14">
                                </div>
            ...
            <div class="col-md-7 order-md-1">
                ...
                <div class="border-bottom py-3 mb-3">
                    ...
                    <div class="ps-3 pb-2">
                        <div class="d-flex align-items-center pt-3 pb-2 mb-1">
                            ...
                            <span class="h6 mb-0 me-4">Cromā Company</span>
                ...
                <div class="border-bottom py-3 mb-3">
                    ...
                    <p class="fs-sm">iPhone 14 is a reliable upgrade with notable improvements in performance and camera
                        quality. However, the higher price and the lack of groundbreaking design changes might make
                        potential buyers pause. If you're due for an upgrade and prioritize performance and camera
                        enhancements, the iPhone 14 is a solid choice, but budget-conscious consumers may want to weigh
                        their options.</p>
                    <div class="d-flex gap-2 pt-1 pb-3">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/product/reviews/01.png') }}"
                            class="d-block rounded-2 me-1" width="86" alt="Image">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/product/reviews/02.png') }}"
                            class="d-block rounded-2 me-1" width="86" alt="Image">
                        <img src="{{ asset('frontend/assets/img/shop/electronics/product/reviews/03.png') }}"
                            class="d-block rounded-2 me-1" width="86" alt="Image">
                    </div>
                    <div class="nav align-items-center">
                        <button type="button" class="nav-link animate-underline px-0">
                ...
                <div class="border-bottom py-3 mb-3">
                    ...
                    <p class="fs-sm">iPhone 14 impresses with its camera prowess, delivering high-quality images.
                        ...
                        audio accessories, requiring them to adapt to wireless alternatives or use an adapter.</p>
                    <ul class="list-unstyled fs-sm pb-2 mb-1">
