...
@section('content')
    ...
    <div class="container h-100 py-5 my-md-2 my-lg-3 my-xl-4 mb-xxl-5">
      ...
      <div class="row align-items-center justify-content-center gx-3 gx-sm-4 mb-3 mb-sm-4">
                ...
                @foreach($popular_products as $index => $product)
                  ...
                  <div class="swiper-slide">
                    <div class="ratio ratio-1x1">
                      <img
                        src="{{ asset($prevProduct->thumbnail ?? 'frontend/assets/img/home/furniture/hero-slider/th01.png') }}"
                        alt="{{ $prevProduct->productName }}">
                    </div>
                  </div>
                @endforeach
              </div>
          ...
          <div class="swiper user-select-none rounded-pill" data-swiper='{
            ...
            <div class="swiper-wrapper">
              @foreach($popular_products as $product)
                <div class="swiper-slide" data-swiper-binded="#description{{ $loop->iteration }}">
                  <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                    <img src="{{ asset($product->thumbnail ?? 'frontend/assets/img/home/furniture/hero-slider/01.png') }}"
        ...
        <div class="col-auto col-sm-1 order-2 order-sm-3 order-lg-4 d-flex align-items-center justify-content-center">
          <button type="button"
            class="btn-next btn btn-lg btn-icon btn-outline-secondary rounded-circle animate-slide-end" aria-label="Next">
              ...
              <div class="swiper-wrapper">
                @foreach($popular_products as $index => $product)
                  ...
                  <div class="swiper-slide">
                    <div class="ratio ratio-1x1">
                      <img
                        src="{{ asset($nextProduct->thumbnail ?? 'frontend/assets/img/home/furniture/hero-slider/th02.png') }}"
        ...
        <div class="swiper-wrapper">
          @foreach($popular_products as $product)
            <div class="swiper-slide bg-body-tertiary text-center">
              ...
              <p class="h4 mb-4">₹{{ number_format($product->price, 2) }}</p>
          ...
          <div class="swiper user-select-none rounded-pill" data-swiper="{
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide" data-swiper-binded="#description1">
                <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/01.png')}}" alt="Image">
                </div>
              </div>
              <div class="swiper-slide" data-swiper-binded="#description2">
                <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/02.png')}}" alt="Image">
                </div>
              </div>
              <div class="swiper-slide" data-swiper-binded="#description3">
                <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/03.png')}}" alt="Image">
                </div>
              </div>
              <div class="swiper-slide" data-swiper-binded="#description4">
                <div class="ratio" style="--cz-aspect-ratio: calc(400 / 636 * 100%)">
                  <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/04.png')}}" alt="Image">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="position-relative user-select-none" style="width: 262px">
            ...
            <div class="swiper position-relative z-2 opacity-60 rounded-circle pe-none" id="thumbsNext" data-swiper="{
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="ratio ratio-1x1">
                    <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/th02.png')}}" alt="Thumbnail">
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="ratio ratio-1x1">
                    <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/th03.png')}}" alt="Thumbnail">
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="ratio ratio-1x1">
                    <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/th04.png')}}" alt="Thumbnail">
                  </div>
                </div>
                <div class="swiper-slide">
                  <div class="ratio ratio-1x1">
                    <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/th01.png')}}" alt="Thumbnail">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col col-md-4 col-lg-3 col-xl-2 mb-4">
            <div class="category-card w-100 text-center px-1 px-lg-2 px-xxl-3 mx-auto" style="min-width: 165px">
              <div class="category-card-body">
                ...
                <!-- Category main image -->
                <a class="d-block text-decoration-none" href="{{ route('catalog', ['category' => $category->catName]) }}">
                  <div class="bg-body-tertiary rounded-pill mb-3 mx-auto" style="max-width: 164px">
                    <div class="ratio ratio-1x1">
                      <img src="{{ asset($category->catImg ?? 'frontend/assets/img/home/furniture/categories/01.png') }}"
                        class="rounded-pill" alt="{{ $category->catName }}">
                    </div>
                  </div>
                ...
                <!-- Optional: If you have subcategories or items -->
                    ...
                    @foreach($category->products as $pro)
                      <li class="w-100">
                        <a class="nav-link justify-content-center min-w-0 w-100 fw-normal hover-effect-underline p-0"
                          href="{{ route('catalog', ['subcategory' => $pro->productName]) }}">
                          <span class="text-truncate">{{ $pro->productName }}</span>
                        </a>
                      </li>
                    @endforeach
                  </ul>
  ...
  <!-- Features -->
  <section class="container pt-5 mt-1 mt-sm-3 mt-lg-4 d-none">
  ...
  <section class="container pb-5 pt-5 mt-1 mt-sm-2 mt-md-3 mt-lg-4 mb-2 mb-sm-3 mb-md-4 mb-xl-5 d-none">
    ...
    <div class="row g-4 g-sm-3 g-lg-4 mb-xxl-3">
      <div class="col-sm-5 d-flex flex-column gap-4 gap-sm-3 gap-lg-4">
        ...
        <div class="ratio" id="hotspots" style="--cz-aspect-ratio: calc(500 / 526 * 100%)">
          ...
          <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 d-none-rtl" href="#!"
            ...
            data-bs-placement="top" data-bs-custom-class="popover-sm" data-bs-content="
                                                                                                <div class=&quot;d-flex align-items-start position-relative&quot;>
                                                                                                  <img src=_assets/img/home/furniture/gallery/hotspot01.html width=&quot;64&quot; alt=&quot;Image&quot;>
                                                                                                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                                                                                                    <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_#>Indigo coushy low sofa</a>
          ...
          <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 d-none d-flex-rtl" href="#!"
            style="top: 63.4%; right: 18.5%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus"
            data-bs-placement="top" data-bs-custom-class="popover-sm" data-bs-content="
                                                                                                <div class=&quot;d-flex align-items-start position-relative&quot;>
                                                                                                  <img src=_assets/img/home/furniture/gallery/hotspot01.html width=&quot;64&quot; alt=&quot;Image&quot;>
                                                                                                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
          ...
          <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 d-none-rtl" href="#!"
            ...
            data-bs-placement="bottom" data-bs-custom-class="popover-sm" data-bs-content="
                                                                                                <div class=&quot;d-flex align-items-start position-relative&quot;>
                                                                                                  <img src=_assets/img/home/furniture/gallery/hotspot02.html width=&quot;64&quot; alt=&quot;Image&quot;>
                                                                                                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                                                                                                    <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_#>Ergonomic beige armchair</a>
          ...
          <!-- Show when the direction is set to RTL -->
          <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 d-none d-flex-rtl" href="#!"
            style="top: 60%; right: 78%" data-bs-toggle="popover" data-bs-html="true" data-bs-trigger="focus"
            data-bs-placement="bottom" data-bs-custom-class="popover-sm" data-bs-content="
                                                                                                <div class=&quot;d-flex align-items-start position-relative&quot;>
                                                                                                  <img src=_assets/img/home/furniture/gallery/hotspot02.html width=&quot;64&quot; alt=&quot;Image&quot;>
                                                                                                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
          ...
          <a class="btn btn-icon btn-sm btn-light rounded-circle shadow position-absolute z-2 start-50 translate-middle-x"
            ...
            data-bs-placement="top" data-bs-custom-class="popover-sm" data-bs-content="
                                                                                                <div class=&quot;d-flex align-items-start position-relative&quot;>
                                                                                                  <img src=_assets/img/home/furniture/gallery/03.html width=&quot;64&quot; alt=&quot;Image&quot;>
                                                                                                  <div class=&quot;nav flex-column pt-2 ps-2 ms-1&quot;>
                                                                                                    <a class=&quot;nav-link hover-effect-underline stretched-link p-0 mb-2&quot; href=_#>Waves modern painting</a>
          ...
          <img src="{{ asset('frontend/assets/img/home/furniture/gallery/01.jpg')}}" class="rounded-5" alt="Image">
        </div>

        <!-- Item -->
        <div class="ratio" style="--cz-aspect-ratio: calc(529 / 526 * 100%)">
          <img src="{{ asset('frontend/assets/img/home/furniture/gallery/02.jpg')}}" class="rounded-5" alt="Image">
        </div>
      </div>
      <div class="col-sm-7 d-flex flex-column gap-4 gap-sm-3 gap-lg-4">
        ...
        <div class="ratio" style="--cz-aspect-ratio: calc(664 / 746 * 100%)">
          <img src="{{ asset('frontend/assets/img/home/furniture/gallery/03.jpg')}}" class="rounded-5" alt="Image">
        </div>

        <!-- Item -->
        <div class="ratio" style="--cz-aspect-ratio: calc(365 / 746 * 100%)">
          <img src="{{ asset('frontend/assets/img/home/furniture/gallery/04.jpg')}}" class="rounded-5" alt="Image">
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Sale Banner (CTA) -->
  <section class="container pt-5 mt-sm-2 mt-md-3 mt-lg-4 pb-5 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
    <div class="row g-0">
        ...
        <div class="position-relative">
          ...
          <div class="row align-items-center position-relative z-2">
            ...
            <div class="col-md-6 d-flex justify-content-center justify-content-md-end pb-5 pb-md-0">
              <div class="me-xxl-4">
                <!-- <img src="{{ asset('frontend/assets/img/home/electronics/banner/camera.png') }}"
                                                                                                                class="d-block rtl-flip" width="420" alt="Camera"> -->
                <img src="{{ asset('frontend/assets/img/home/furniture/hero-slider/02.png') }}" class="d-block rtl-flip"
  ...
  <section class="container pb-5 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
    <div class="row row-cols-1 row-cols-md-3 gy-3 gy-sm-4 gx-2 gx-lg-4 mb-xxl-3">
      <div class="col text-center">
        <svg class="d-block text-dark-emphasis mx-auto mb-3 mb-lg-4" xmlns="http://www.w3.org/2000/svg" width="64"
        ...
        <p class="fs-sm px-5 mb-md-0">Decorate your space with eco-friendly furniture with low VOCs, environmentally
      ...
      <div class="col text-center">
        ...
        <p class="fs-sm px-5 mb-md-0">We choose raw materials from the best manufacturers, so our furniture and decor
          are of the highest quality at the best prices.</p>
      </div>
      <div class="col text-center">
        <svg class="d-block text-dark-emphasis mx-auto mb-3 mb-lg-4" xmlns="http://www.w3.org/2000/svg" width="64"
          height="64" viewBox="0 0 64 64" fill="currentColor">
        ...
        <p class="fs-sm px-5 mb-md-0"> We will deliver to your door anywhere in the world. If you're not 100%
    ...
    <div class="row gy-5 mb-xxl-3">
      ...
      <article class="col-md-6">
        <a class="ratio d-flex hover-effect-scale rounded-4 overflow-hidden" href="#!"
          ...
          <img src="{{ asset('frontend/assets/img/blog/grid/v2/01.jpg')}}" class="hover-effect-target" alt="Image">
        </a>
        <div class="pt-4">
        ...
        <div class="row row-cols-1 row-cols-sm-2 gy-5">
          ...
          <article class="col">
            ...
            <div class="pt-4">
              ...
              <h3 class="h6 mb-3">
                <a class="hover-effect-underline" href="#!">Transform your living space with these chic interior
                  design tips</a>
              </h3>
              <div class="nav align-items-center gap-2 fs-xs">
          ...
          <article class="col">
            ...
            <div class="pt-4">
              ...
              <h3 class="h6 mb-3">
                <a class="hover-effect-underline" href="#!">Furnishing your space: a guide to choosing the perfect
                  furniture pieces</a>
              </h3>
              <div class="nav align-items-center gap-2 fs-xs">
