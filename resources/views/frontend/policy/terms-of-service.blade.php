...
@section('content')
    ...
    <div class="container py-5 mb-2 mb-sm-3 mb-lg-4 mb-xl-5">
        <h1 class="h2 position-relative pb-sm-2 pb-md-3 text-center mt-4" style="z-index: 1021">Terms of service</h1>
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="terms-content">
                    <p><strong>OVERVIEW</strong>
                        <br> This website is operated by Sitwell Chairs. Throughout the site,
                        the terms "we", "us" and "our" refer to Sitwell Chairs. Sitwell Chairs offers this website,
                        ...
                        visiting
                        our site and/ or purchasing something from us, you engage in our "Service" and agree to be bound
                        by the
                        ...
                        all users
                        of the site, including without limitation users who are browsers, vendors, customers, merchants,
                        and/ or
                        contributors of content. <br> <br> Please read these Terms of Service carefully before accessing
                        or
                        ...
                        expressly limited
                        to these Terms of Service. <br> <br> Any new features or tools which are added to the current
                        store
                        shall also be subject to the Terms of Service. You can review the most current version of the
                        Terms of
                        Service at any time on this page. We reserve the right to update, change or replace any part of
                        these Terms of
                        ...
                        of any changes
                        constitutes acceptance of those changes. <br> <br> Our store is hosted on our e-commerce
                        platform that allows us to sell our products and Services to you. <br> <br>

                    <h5 class="text-muted ">SECTION 1 - ONLINE STORE TERMS</h5>
                    ...
                    <h5 class="text-muted ">SECTION 2 - GENERAL CONDITIONS</h5>
                    ...
                    <h5 class="text-muted ">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h5>
                    ...
                    <h5 class="text-muted ">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h5>
                    ...
                    <h5 class="text-muted ">SECTION 5 - PRODUCTS OR SERVICES</h5>
                    ...
                    <h5 class="text-muted ">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h5>
                    ...
                    <h5 class="text-muted ">SECTION 7 - OPTIONAL TOOLS</h5>
                    ...
                    <h5 class="text-muted ">SECTION 8 - THIRD-PARTY LINKS</h5>
                    ...
                    <h5 class="text-muted ">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h5>
                    ...
                    <h5 class="text-muted ">SECTION 10 - PERSONAL INFORMATION</h5>
                    <p>Your submission of personal information through the store is governed by our Privacy Policy.</p>

                    <h5 class="text-muted ">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h5>
                    ...
                    <h5 class="text-muted ">SECTION 12 - PROHIBITED USES</h5>
                    ...
                    <h5 class="text-muted ">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h5>
                    ...
                    <p>In no case shall Sitwell Chairs, our directors, officers, employees, affiliates, agents,
                    ...
                    <h5 class="text-muted ">SECTION 14 - INDEMNIFICATION</h5>
                    <p>You agree to indemnify, defend and hold harmless Sitwell Chairs and our parent, subsidiaries,
                    ...
                    <h5 class="text-muted ">SECTION 15 - SEVERABILITY</h5>
                    ...
                    <h5 class="text-muted ">SECTION 16 - TERMINATION</h5>
                    ...
                    <h5 class="text-muted ">SECTION 17 - ENTIRE AGREEMENT</h5>
                    ...
                    <h5 class="text-muted ">SECTION 18 - GOVERNING LAW</h5>
                    ...
                    <h5 class="text-muted ">SECTION 19 - CHANGES TO TERMS OF SERVICE</h5>
                    ...
                    <h5 class="text-muted ">SECTION 20 - CONTACT INFORMATION</h5>
                    <p>Questions about the Terms of Service should be sent to us at info@sitwellchairs.in.</p>

                    <div class="contact-info">
                        <h5 class="text-muted">Our contact information is posted below:</h5>
