...
@section('content')
    ...
    <nav class="container pt-3 my-3 my-md-4" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('catalog')}}">Shop</a></li>
    ...
    <section class="container pb-2 pb-lg-4">
        <div class="d-flex align-items-center border-bottom">
            <ul class="nav nav-underline flex-nowrap gap-4">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('product-review')}}">Reviews (68)</a>
                </li>
            </ul>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/01.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/01.png') }}"
                                    data-zoom-options="{
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/02.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/02.png') }}"
                                    data-zoom-options="{
                          &quot;paneSelector&quot;: &quot;#zoomPane&quot;,
                          &quot;inlinePane&quot;: 768,
                          &quot;hoverDelay&quot;: 500,
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/03.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/03.png') }}"
                                    data-zoom-options="{
                          &quot;paneSelector&quot;: &quot;#zoomPane&quot;,
                          &quot;inlinePane&quot;: 768,
                          &quot;hoverDelay&quot;: 500,
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/04.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/04.png') }}"
                                    data-zoom-options="{
                          &quot;paneSelector&quot;: &quot;#zoomPane&quot;,
                          &quot;inlinePane&quot;: 768,
                          &quot;hoverDelay&quot;: 500,
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/05.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/05.png') }}"
                                    data-zoom-options="{
                          &quot;paneSelector&quot;: &quot;#zoomPane&quot;,
                          &quot;inlinePane&quot;: 768,
                          &quot;hoverDelay&quot;: 500,
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/06.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/06.png') }}"
                                    data-zoom-options="{
                          &quot;paneSelector&quot;: &quot;#zoomPane&quot;,
                          &quot;inlinePane&quot;: 768,
                          &quot;hoverDelay&quot;: 500,
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-1x1">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/07.png') }}"
                                    data-zoom="{{ asset('frontend/assets/img/shop/electronics/product/gallery/07.png') }}"
                                    data-zoom-options="{
                          &quot;paneSelector&quot;: &quot;#zoomPane&quot;,
                          &quot;inlinePane&quot;: 768,
                          &quot;hoverDelay&quot;: 500,
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th01.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th02.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th03.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th04.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th05.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th06.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                        <div class="swiper-slide swiper-thumb">
                            <div class="ratio ratio-1x1" style="max-width: 94px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/product/gallery/th07.png') }}"
                                    class="swiper-thumb-img" alt="Thumbnail">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="position-relative" id="zoomPane">
                        ...
                        <div
                            ...
                            <div class="count-input flex-shrink-0 order-sm-1">
                                ...
                                <input type="number" class="form-control form-control-lg" value="1" min="1" max="5"
                                    readonly="">
                        ...
                        <div class="d-flex flex-wrap gap-3 gap-xl-4 pb-4 pb-lg-5 mb-2 mb-lg-0 mb-xl-2">
                            <div class="d-flex align-items-center fs-sm">
                                ...
                                <div class="text-body-emphasis text-nowrap"><span class="fw-semibold">+32</span> bonuses
                                </div>
                            </div>
                            <div class="d-flex align-items-center fs-sm">
                                <svg class="text-primary me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="none">
                                    <path
                        ...
                        <div class="accordion-item border-top">
                            ...
                            <div class="accordion-collapse collapse" id="warranty" aria-labelledby="headingWarranty"
                                ...
                                <div class="accordion-body">
                                    ...
                                    <p class="mb-0">Explore the details of our <a class="fw-medium" href="#!">product
                                            warranties here</a>, including duration, coverage, and any additional
                                        protection plans available. We prioritize your satisfaction, and our warranty
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="payment" aria-labelledby="headingPayment"
                                ...
                                <div class="accordion-body">Experience hassle-free transactions with our <a
                                        class="fw-medium" href="#!">flexible payment options</a> and credit facilities.
                                    Learn more about the various payment methods accepted, installment plans, and any
                                    exclusive credit offers available to make your shopping experience seamless.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container d-flex align-items-center">
                    <div class="d-flex align-items-center min-w-0 ms-n2 me-3">
                        <div class="ratio ratio-1x1 flex-shrink-0" style="width: 50px">
                            <img src="{{ asset('frontend/assets/img/shop/electronics/thumbs/10.png') }}" alt="iPhone 14">
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between pb-4 mb-2" style="min-width: 840px">
                            ...
                            <div class="w-100" style="max-width: 306px">
                                <div class="form-check position-relative p-0 m-0 mb-3">
                                    <input type="checkbox" class="form-check-input position-absolute top-0 end-0 mt-3 me-3"
                                    ...
                                    <label for="iphone" class="d-flex justify-content-center bg-body rounded p-3">
                                        <span class="ratio d-block"
                                            ...
                                            <img src="{{ asset('frontend/assets/img/shop/electronics/14.png') }}"
                                                alt="iPhone 14">
                                        </span>
                                    </label>
                                </div>
                            ...
                            <div class="w-100" style="max-width: 306px">
                                <div class="form-check position-relative p-0 m-0 mb-3">
                                    ...
                                    <label for="airpods" class="d-flex justify-content-center bg-body rounded p-3">
                                        <span class="ratio d-block"
                                            style="max-width: 258px; --cz-aspect-ratio: calc(240 / 258 * 100%)">
                                            <img src="{{ asset('frontend/assets/img/shop/electronics/06.png') }}"
                                                alt="AirPods 2 Pro">
                                        </span>
                                    </label>
                                </div>
                            ...
                            <div class="w-100" style="max-width: 306px">
                                <div class="form-check position-relative p-0 m-0 mb-3">
                                    ...
                                    <label for="charger" class="d-flex justify-content-center bg-body rounded p-3">
                                        <span class="ratio d-block"
                                            style="max-width: 258px; --cz-aspect-ratio: calc(240 / 258 * 100%)">
                                            <img src="{{ asset('frontend/assets/img/shop/electronics/15.png') }}"
                            ...
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    ...
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/01.png') }}"
                                            alt="VR Glasses">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/02.png') }}"
                                            alt="iPhone 14">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/03.png') }}"
                                            alt="Smart Watch">
                                    </div>
                                </a>
                            </div>
    ...
    <section class="container pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5">
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="nav">
                    <a class="nav-link text-primary animate-underline px-0" href="{{ route('product-details')}}">
                ...
                <div class="border-bottom py-3 mb-3">
                    ...
                    <p class="fs-sm">The phone has a new A15 Bionic chip, which makes it lightning-fast and responsive.
                        The camera system has also been upgraded, and it now includes a 12-megapixel ultra-wide lens and
                        a 12-megapixel wide lens.</p>
                ...
                <div class="nav">
                    <a class="nav-link text-primary animate-underline px-0" href="{{ route('product-review')}}">
                    ...
                    <div class="border rounded p-3 p-lg-4">
                        <div class="d-flex align-items-center mb-3">
                            <div class="ratio ratio-1x1 flex-shrink-0" style="width: 110px">
                                <img src="{{ asset('frontend/assets/img/shop/electronics/thumbs/10.png') }}" width="110"
                                    alt="iPhone 14">
                            </div>
                        ...
                        <div class="d-flex gap-2 gap-lg-3">
                            ...
                            <button type="button" class="btn btn-icon btn-secondary animate-pulse" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-custom-class="tooltip-sm" data-bs-title="Add to Wishlist"
                                aria-label="Add to Wishlist">
                                <i class="ci-heart fs-base animate-target"></i>
                            </button>
                            <button type="button" class="btn btn-icon btn-secondary animate-rotate" data-bs-toggle="tooltip"
                                data-bs-placement="top" data-bs-custom-class="tooltip-sm" data-bs-title="Compare"
                                aria-label="Compare">
                                <i class="ci-refresh-cw fs-base animate-target"></i>
                            </button>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/13.png') }}"
                                            alt="Dualsense Edge">
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    ...
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/11.png') }}"
                                            alt="Nikon Camera">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="position-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/10.png') }}"
                                            alt="iPhone 14">
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="product-card animate-underline hover-effect-opacity bg-body rounded">
                            <div class="posittion-relative">
                                ...
                                <a class="d-block rounded-top overflow-hidden p-3 p-sm-4" href="#!">
                                    <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                                        <img src="{{ asset('frontend/assets/img/shop/electronics/07.png') }}"
                                            alt="iPad Pro">
                                    </div>
                                </a>
                            </div>
