                    ...
                    <div class="col-3">
                        <div class="text-center">
                            @canany(['manage users', 'create users'])
                                <a class="btn btn-primary" href="{{ route('mgmt-user.create') }}"><i class="ti ti-plus"></i>
                                    Add New User </a>
                            @endcanany
                        </div>
                    </div>
                                    ...
                                    <tr class="userRow">
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if(auth()->user()->userType === 'superAdmin')
                                                <small>({{ $us->parentAdmin->name }})</small>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <p class="mb-0 fw-normal">{{ $us->email }}</p>
                                        </td>
                                        <td>
                                            <div class="d-flex justify-content-center align-items-center gap-2">
                                                <span
                                                    class="badge bg-success rounded-3 fw-semibold">{{ $us->parentAdmin->name }}</span>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dropdown">
                                                    ...
                                                    @canany(['manage users', 'edit users'])
                                                        <li>
                                                            <a class="dropdown-item text-primary"
                                                                href="{{ route('mgmt-user.edit', $us->id) }}">
